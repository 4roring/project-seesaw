...
const TS_DATA = {
  ...
  STARTER_DECKS: {
    ...
    RED: [
      ...
      { key: 'brace', name: '기수응세', cost: 1, damage: 0, block: 5, count: 1, chainBlock: 4 },
      ...
      { key: 'chainstrike', name: '연환매화', cost: 1, damage: 3, block: 0, count: 1, chain: 4 },
      { key: 'chain_burst', name: '매화만개', cost: 3, damage: 8, block: 0, count: 1, chain: 7 },
    ],
    BLUE: [
      ...
      { key: 'memflush', name: '배수일전', cost: 2, damage: 4, block: 0, count: 1, discardAll: 8 },
    ],
    BLACK: [
    ...
    YELLOW: [
      { key: 'siphon', name: '흡성소법', cost: 1, damage: 7, block: 0, count: 3, hpCost: 1, lifesteal: 50 },
      { key: 'firstaid', name: '회춘결', cost: 1, damage: 0, block: 0, count: 3, heal: 8 },
      { key: 'corrode', name: '부식장', cost: 2, damage: 7, block: 0, count: 2, bossWeaken: true },
      { key: 'regen', name: '심법: 환혈공', cost: 1, damage: 0, block: 0, count: 1, effect: 'PERSISTENT_HEAL_ON_TURN_START', persistentPayload: { id: 'aura-heal-on-turn', name: '환혈공', amount: 5, turns: 2 } },
  ...
  REWARD_POOLS: {
    ...
    BLUE: {
      ...
      2: [
        ...
        { key: 'cache_burn', name: '배수결의', cost: 2, damage: 6, block: 0, discardAll: 11 },
        { key: 'logic_bomb', name: '태극붕권', cost: 3, damage: 14, block: 8 },
        { key: 'defrag', name: '조식정기', cost: 2, damage: 0, block: 0, draw: 2, rewind: 1 },
        { key: 'redirect', name: '이화접목', cost: 2, damage: 0, block: 0, evade: 2 },
      ],
      3: [
        { key: 'overflow', name: '창해노도', cost: 4, damage: 31, block: 0, draw: 2 },
        { key: 'infinite_loop', name: '무극환류', cost: 3, damage: 0, block: 0, rewind: 2, draw: 2 },
        ...
        { key: 'total_flush', name: '배수천붕', cost: 3, damage: 8, block: 0, discardAll: 17 },
    ...
    YELLOW: {
      1: [
        { key: 'bloodsuck', name: '흡혈수', cost: 1, damage: 6, block: 0, lifesteal: 50 },
      ...
      2: [
        ...
        { key: 'healing_light', name: '회광반조', cost: 2, damage: 0, block: 0, heal: 14 },
        ...
        { key: 'drain_wave', name: '흡성파', cost: 3, damage: 16, block: 0, lifesteal: 50 },
      ],
      3: [
        { key: 'sacrifice', name: '사혈일격', cost: 3, damage: 24, block: 0, hpCost: 8 },
        { key: 'great_regen', name: '대환단공', cost: 3, damage: 0, block: 0, heal: 18, effect: 'PERSISTENT_HEAL_ON_TURN_START', persistentPayload: { id: 'aura-heal-on-turn', name: '대환단공', amount: 4, turns: 3 } },
        { key: 'doom_pact', name: '멸혼혈약', cost: 5, damage: 40, block: 0, hpCost: 5 },
        { key: 'life_convert', name: '환혈전공', cost: 4, damage: 31, block: 0, heal: 8 },
        { key: 'final_awakening', name: '마혼각성', cost: 6, damage: 48, block: 0, hpCost: 10 },
        { key: 'great_drain', name: '흡성신공', cost: 5, damage: 36, block: 0, lifesteal: 50 },
      ],
    },
  },
  ...
  ENEMIES: [
    {
      ...
      skills: [
        ...
        { key: 'aoe_slam', name: '횡소천군', cost: 4, kind: 'ATTACK_VULNERABLE', damage: 12, cooldown: 4, priority: 40 },
      ],
    },
    {
      ...
      skills: [
        ...
        { key: 'blast', name: '난도질', cost: 3, kind: 'ATTACK_VULNERABLE', damage: 14, cooldown: 3, priority: 35 },
      ],
    },
    {
    ...
    },
    {
      ...
      skills: [
        ...
        { key: 'watcher_rage', name: '쌍룡출해', cost: 3, kind: 'ATTACK_WEAKEN', damage: 9, cooldown: 2, priority: 35 },
        { key: 'doom_gaze', name: '천라검막', cost: 5, kind: 'ATTACK_VULNERABLE', damage: 14, cooldown: 4, priority: 45 },
      ],
    },
    {
      ...
      skills: [
        ...
        { key: 'erode', name: '탈혼장', cost: 2, kind: 'ATTACK_WEAKEN', damage: 9, cooldown: 1, priority: 30 },
        { key: 'devour', name: '아귀탄', cost: 4, kind: 'ATTACK_VULNERABLE', damage: 14, cooldown: 3, priority: 45 },
      ],
    },
    {
    ...
    },
    {
      ...
      skills: [
        ...
        { key: 'collapse', name: '붕산권', cost: 4, kind: 'ATTACK_WEAKEN', damage: 12, cooldown: 3, priority: 40 },
        { key: 'judgment', name: '천마군림', cost: 5, kind: 'ATTACK_VULNERABLE', damage: 14, cooldown: 4, priority: 50 },
        { key: 'final_calc', name: '멸천지세', cost: 6, kind: 'ATTACK_VULNERABLE', damage: 14, cooldown: 6, priority: 55 },
      ],
    },
  ],
};
